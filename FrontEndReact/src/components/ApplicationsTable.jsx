                ...
                <table className="w-full min-w-[900px] border-collapse text-left font-sans text-sm">
                    ...
                    <tbody>
                        {applications.length === 0 ? (
                            <tr>
                                <td colSpan={8} className="py-8 text-center text-dash-muted">
                            ...
                            applications.map((application) => (
                                <tr key={application.id} className="border-b border-dash-rule">
                                    ...
                                    <td className="py-2.5 pr-3">
                                        <span className={`inline-block rounded-[5px] px-2 py-0.5 text-xs font-medium ${STATUS_PILL[application.status] || "bg-[#F0EEEA] text-[#6B6560]"}`}>
                                            {application.status}
                                        </span>
                                    </td>
                                    <td className="py-2.5 pr-3 text-dash-muted">—</td>
                                    <td className="py-2.5 pr-3 text-dash-muted">—</td>
                                    <td className="py-2.5 pr-3">
                                        {application.job_url ? (
